...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 01cd843b-a41a-4547-83c9-beb85984e9b0
```

> `01cd843b-a41a-4547-83c9-beb85984e9b0` is the password of the certificate, you can change it to any password you want.
